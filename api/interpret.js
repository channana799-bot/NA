...
### 2. 逐牌解读预示含义（重要）
对每一张牌，必须明确说明"这张牌出现在这个位置意味着什么"。例如：
- 如果死神出现在"当前"位置，解释这预示着什么转变正在发生
- 如果逆位出现，说明什么在受阻、什么需要调整
- 将牌的关键词自然地转化为对用户处境的直接影射
...
${isDeep ? `### 7. 深度附加要求
- 适当引用韦特塔罗的符号象征（牌面中的人物姿态、背景元素、数字含义）来丰富解读
- 从心理学或灵性成长的角度提供更深层的洞察
- 分析元素能量之间是否存在冲突或和谐共振
